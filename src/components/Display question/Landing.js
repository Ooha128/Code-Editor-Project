...
let qsn={
  qsnId : "HELW",
  title: "Hello World!",
  description: "In this task you have to take an input string from the user and print the same in output.",
  testCases: [
    {
      id: 1,
      input: "Ooha",
  ...
  inputFormat: "There is one line of text",
  outputFormat: "There is one line of text",
  SampleInput:["Hello World"],
  SampleOutput:["Hello World"],
  difficulty: "Easy"
};
let tcs=qsn.testCases;
const Landing = () => {
